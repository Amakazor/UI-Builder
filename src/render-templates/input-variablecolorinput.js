const inputvariablecolorinput = `
	<div class="custom-variable_input">
	    <label class="switchVariableLabel col-sm-8" for="switchVariable{%=key%}">Use variable</label>
	    <input class="col-sm-2 switchVariable" id="switchVariable{%=key%}" data-key="switchVariable" type="checkbox">
